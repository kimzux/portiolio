      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full ">
        <div className="pb-8 xl:px-2 mb-8 text-center lg:mb-16">
          ...
          <p className="xl:max-w-2xl px-4 mx-auto text-lg text-gray-800 sm:px-10 md:text-xl md:max-w-3xl md:px-0">
            ...
            current skills interms of programming and technology
          </p>
        </div>
        <div className="container mx-auto max-w-7xl flex flex-col space-y-12 px-4 sm:px-10 lg:flex-row lg:space-y-0 lg:space-x-16 xl:flex-row xl:space-y-0 xl:space-x-16 2xl:flex-row 2lx:space-y-0 2lx:space-x-16">
          <div className="w-full">
            <p className="font-bold text-xl mt-0">Get to know me!</p>
            <br />
            <div className="flex flex-col items-center space-y-4 mb-8 text-lg text-gray-800 lg:mb-10">
              <p className="text-6 text-justify ">
                I'm a Frontend Web Developer with a passion for building up
                beautiful and responsive websites. I have worked on a few
                projects that demonstrates my ability to make use of the
                concepts I've learned. You can check them out in the Projects
                section.
              </p>
              <br />

              <p className="text-6 text-justify ">
                I enjoy sharing and interacting with people in the Web Dev
                world. I believe that this helps me to grow and learn in this
                field. You can connect with me on{" "}
                <a
                  href="https://www.linkedin.com/in/zulfa-rajabu-9420461a4/"
            ...
            <a
              href="mailto:kimzux0718@gmail.com"
          ...
          <div class="w-full xl:ml-8 2xl:ml-8 lg:ml-8">
            <h3 class="mb-6 text-lg font-bold mt-0 xl:mt-0 2xl:mt-0 lg:mt-0 ">
              My Skills
            </h3>
