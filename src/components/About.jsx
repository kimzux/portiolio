                    ...
                    <div class="w-full xl:ml-8 2xl:ml-8 lg:ml-8">
                        ...
                        <div class="flex flex-col space-y-4">
                            <div class="flex space-x-4">
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded">
                                    <span>HTML</span>
                                </div>
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded">
                                    <span>CSS</span>
                                </div>
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded"><span>php</span>
                                </div>
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded"><span>laravel</span>
                                </div>
                            </div>
                            <div class="flex space-x-4">
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded">
                                    <span>JavaScript</span>
                                </div><div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded">
                                    <span>React</span>
                                </div>
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded"><span>Git</span>
                                </div>
                                <div class="flex items-center justify-center w-full px-3 py-3 bg-pincolor-900 text-gray-800 font-semibold rounded">
